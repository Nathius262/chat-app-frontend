function MessageBody(){
    ...
    <ul class="list-unstyled mt-4">
        <li class="sender list-img px-0 pt-3 pb-1 pt-1 d-flex align-items-center">                            
            <div class="">
                <p class="message-text-sender fs-4 fw-normal mb-0">Hi nath this is awesome</p>
        ...
        <li class="receiver list-img px-0 pt-3 pb-1 pt-1 d-flex align-items-center">
            <div class="img-profile"></div>
            <div class="">
                <p class="message-text-receiver fs-4 fw-normal mb-0">Hi! whoever you are just wanted be sure that you're doing what you to do</p>
                <p class="fs-6 fw-light mt-0 px-2">30 Wed 15:12</p>
            </div>
        ...
        <li class="receiver list-img px-0 pt-3 pb-1 pt-1 d-flex align-items-center">
            <div class="img-profile"></div>
            <div class="">
                <p class="message-text-receiver fs-4 fw-normal mb-0">Hi nath this is awesome</p>
                <p class="fs-6 fw-light mt-0 px-2">30 Wed 15:12</p>
            </div>
